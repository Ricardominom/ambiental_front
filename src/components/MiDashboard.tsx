    ...
    <div className="h-[calc(100vh-5rem)] relative overflow-hidden bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50">
      ...
      <div className="relative z-10 p-4 h-full flex flex-col">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 h-full">
          {/* First Column - Special distribution */}
          <div className="flex flex-col gap-4 h-full">
            {/* Río Santa Catarina - 2/3 of first column */}
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-emerald-100 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col h-2/3">
            ...
            {/* Comunicación - 1/3 of first column */}
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-emerald-100 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col h-1/3">
          ...
          {/* Second Column - Manejos de Fauna */}
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-emerald-100 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col h-full">
            <h3 className="text-base font-bold text-gray-800 mb-2 text-center">Río Santa Catarina</h3>
            <div className="flex items-center justify-center mb-2 w-full">
              <span className="text-xs font-semibold text-red-600 bg-red-100 px-3 py-1 rounded-full">
                Últimos reportes
          ...
          {/* Third Column - Protección de ANPs */}
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-emerald-100 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col h-full">
          ...
          {/* Fourth Column - Combined cards */}
          <div className="flex flex-col gap-4 h-full">
            {/* Manejos de Fauna - Top half */}
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-emerald-100 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col h-1/3">
            ...
            {/* Temporadas de servicios - Bottom 2/3 */}
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-emerald-100 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col h-2/3">
        ...
        {/* Second Row - 4 Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mt-4 h-1/2">
          {/* Parques Estatales */}
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-emerald-100 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col">
            <h3 className="text-base font-bold text-gray-800 mb-2 text-center">Contenido Adicional</h3>
            <div className="flex-1 flex items-center justify-center">
              <p className="text-gray-500 text-sm">Espacio disponible para más contenido</p>
            </div>
          </div>
